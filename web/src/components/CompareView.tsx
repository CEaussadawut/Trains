        ...
        >
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={expansion} margin={{ top: 8, right: 12, bottom: 4, left: 4 }} barGap={2}>
              ...
              <YAxis scale="log" domain={["auto", "auto"]} allowDataOverflow={false} {...axisProps} />
              <Tooltip content={<ChartTooltip unit="nodes" />} cursor={{ fill: "rgba(255,255,255,0.04)" }} />
        ...
        >
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={runtime} margin={{ top: 8, right: 12, bottom: 4, left: 4 }}>
              <CartesianGrid stroke={VIZ.grid} vertical={false} />
              <XAxis dataKey="label" {...axisProps} interval={0} angle={-18} textAnchor="end" height={54} />
              <YAxis scale="log" domain={["auto", "auto"]} {...axisProps} unit="ms" />
          ...
          <ResponsiveContainer width="100%" height={260}>
            <ScatterChart margin={{ top: 12, right: 24, bottom: 4, left: 4 }}>
              ...
              <XAxis type="number" dataKey="expanded" name="nodes expanded" scale="log"
                domain={["auto", "auto"]} {...axisProps} />
              <YAxis type="number" dataKey="excess" name="% above optimal" unit="%" {...axisProps} />
              <ZAxis range={[120, 120]} />
